...
# Sample questions that highlight KG advantages - NEP 2020 Questions
DEMO_QUESTIONS = [
    "How does teacher education relate to curriculum changes in NEP?",
    "What are the key stages of education defined in the National Education Policy?",
    "Explain the role of technology in the implementation of NEP across different stages.",
    "How are foundational literacy and numeracy initiatives connected to the preparatory stage?",
    "What is the relationship between assessment reforms and student learning outcomes in NEP?",
    "How does vocational education integrate with the secondary stage of education?",
    "What systemic changes are needed to support digital infrastructure in schools according to NEP?"
]
...
async def initialize_systems():
    ...
    doc_path = script_dir / "sample_data" / "api_documentation.txt"
